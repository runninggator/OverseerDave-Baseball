				...
				<div class='col-md-6'>
		        	<div class="panel panel-default">
						<div class="panel-body">
							...
							<a class="btn btn-primary btn-lg btn-block" href="result.php" role="button">Play Match vs. Computer</a><br>
							<a class="btn btn-primary btn-lg btn-block" href="online.php" role="button">Play Match vs. Online Opponent</a>
						</div>
					</div>
				</div>
